...
class CondicionDeValidacion {
    constructor(seCumple) {
        ...
        this.alNoCumplirse=new ConjuntoDeEventos();//(e:ElementoParaValidacion)=>{}
        const self=this;
        this.seCumple =v=> {
            let resultado= seCumple(v);
            if(!resultado){
                self.__alNoCumplirse();
            }
            return resultado;
            };//()=>bool
    ...
    __alNoCumplirse(){
        const self=this;
        this.alNoCumplirse.ejecutar(self);
    }
    addAlNoCumplirse(metodoAlNoCumplirse){//(e:ElementoParaValidacion)=>{}
        this.alNoCumplirse.add(metodoAlNoCumplirse);
    }
}
...
class ElementoParaValidacion {
    constructor(id,condicionDeValidacion) {
        ...
        }else if(a instanceof CondicionDeValidacion){
            cev=condicionDeValidacion;
        } 
        this.id=id;
        ...
        // this.alNoVAlidar=new ConjuntoDeEventos();//(e:ElementoParaValidacion)=>{}
        
    }
    addAlNoCumplirseLaCondicionDeValidacion(metodoAlNoCumplirse){//(e:ElementoParaValidacion)=>{}
        this.condicionDeValidacion.addAlNoCumplirse(metodoAlNoCumplirse);
        return this;
    }

    // __alNoVAlidar(){
    //     this.alNoVAlidar.ejecutar();
    // }
    // addAlNoVAlidar(metodoAlNoVAlidar){//(e:ElementoParaValidacion)=>{}
    //     this.alNoVAlidar.add(metodoAlNoVAlidar);
    // }
